print("-----1-----")
#Variables are pieces in you code to store and organize data
...
print(age)
print(tired)
#it is good programming etiquette to name your variables something descriptive
# x is not that descriptive, but name is, this makes it easier to find specific variables in your code, and makes it easier to understand
print("-----2-----")
...
#you can perform concatenation to strings
#concatenation is a fancy way of saying you can add the words
#use the plus symbol (+)
...
#so to print each class as its own, use [] again after the list name with the index inside
 
print(classes[0])
print(classes[1])
print(classes[2])
 
#As I'm sure you noticed, I am just typing in the file to write the instructions, but how does the computer know when something is code or words?
#the answer is #
...
#add 18 to your age and print the result
